...
const SmallStat = ({ value, label }) => <div><p className="text-lg font-black text-black">{value}</p><p className="text-[10px] text-zinc-500">{label}</p></div>;
